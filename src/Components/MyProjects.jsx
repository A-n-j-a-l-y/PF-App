     ...
     <div className="mt-4">
      {
        ...
        <div key={index} className="border rounded d-flex justify-content-between align-items-center text-danger mb-3 p-2">
          ...
          <div className="d-flex icons align-items-center">
            ...
            <a target='_blank' className='btn' href={project?.github}><i style={{height:'34px',color:'black'}} className="fa-brands fa-github fa-2x"></i></a>
            <button onClick={()=> handleDeleteProject(project?._id)} className='btn'><i style={{height:'34px',color:'black'}} className="fa-solid fa-trash fa-2x"></i></button>
          </div>
        </div>
        )) :
