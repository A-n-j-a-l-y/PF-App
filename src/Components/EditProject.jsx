...
function EditProject({project}) {
  ...
  return (
    <>
    <button style={{color:'black'}} onClick={handleShow} className='btn'> <i className="fa-solid fa-edit"></i> Edit Project </button>
    <Modal
        show={show}
        onHide={handleClose}
        backdrop="static"
            ...
            <div className="col-lg-6">
              <label>
               <input style={{display:'none'}} type="file" onChange={e=>setProjectData({...projectData,projectImage:e.target.files[0]})} />  
                <img style={{height:'250px'}} className='w-100' src={preview?preview:`${SERVER_URL}/uploads/${project.projectImage}`} alt="Upload Project Image" /></label>
            </div>
            <div className='col-lg-6'>
              <div className="mb-3">
