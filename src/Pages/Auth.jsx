        ...
        <div className="card shadow p-5 bg-success">
          <div className="row align-items-center">
            <div className="col-lg-6">
              <img style={{ height: '350px', width: '350px' }} className='image-fluid' src={loginImg} alt="login" />
            </div>
            <div className="col-lg-6">
                  ...
                  </Form.Group>
                  {
                    insideRegister ?
                      <div>
                        ...
                        <p className='text-dark'>Already have an Account? Click here to <Link className='text-dark' to={'/login'}>Login</Link></p>
                      </div> :
                      <div>
                        ...
                        <p className='text-dark'>New User? Click here to <Link className='text-dark' to={'/register'}>Register</Link></p>
